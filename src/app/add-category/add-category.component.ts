...
export class AddCategoryComponent implements OnInit {
  ...
  data1:any;
  data2:any ={};
  constructor(public rout:Router,public serve:PearlService,public dialog:DialogComponent,public dialog2:MatDialog, public navparams : ActivatedRoute ,@Inject(MAT_DIALOG_DATA) public data)  {
