            ...
            scheme_data(type)
            {
              ...
              deleteCoupons(coupon_date)
              {
                this.dialog1.delete('Coupon Data !').then(result => 
                  ...
                  //     this.excel_data.push({'Product Name':this.productDetail[i].product_name,'Product category':this.productDetail[i].category,'Sub Category':this.productDetail[i].sub_category,'Product Code':this.productDetail[i].cat_no,'Channel Partner Net Price':this.productDetail[i].cn_net_price,'Direct Dealer Net Price':this.productDetail[i].productDetail.dd_net_price,'Master Packing ':this.productDetail[i].master_packing,'Small Packing':this.productDetail[i].secondary_packing,'Price ':this.productDetail[i].city,'Description ':this.productDetail[i].description,'Brand Name':this.productDetail[i].assigned_to,'COLORS':this.productDetail[i].color_name});
                  //   }
                  //   this.serve.exportAsExcelFile(this.excel_data, 'Product Detail Sheet');
                  // }
                 ...
                 excelExport() : void
                      {
                          ...
                          // });
                          XLSX.writeFile(wb, "Product-Detail-Sheet.xls");
                      }
