...
export class OfflineDbProvider {
      ...
      constructor(public http: HttpClient,
            ...
            public onUpdateCategoryIntoLocalDBHandler(db, localDBLastUpdatedTime) {
                  ...
                  this.service.post_rqst({'filter' : filterData},'app_offline_master/parentCategory_List').subscribe((serverResult) => {
            ...
            public onUpdateLocalDBProductHandler(db, currentUpdatedTime) {
                  ...
                  this.service.post_rqst({'filter' : filterData},'app_offline_master/onGetProductListHandler').subscribe((serverResult) => {
