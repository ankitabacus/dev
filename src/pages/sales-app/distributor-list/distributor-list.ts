...
import { IonicPage, NavController, NavParams, LoadingController, App, ModalController,AlertController,Events } from 'ionic-angular';
...
import { ConvertLeadPage } from '../../convert-lead/convert-lead';
...
export class DistributorListPage {
    ...
    userId:any
    constructor( public events: Events,public modal: ModalController,public alertCtrl: AlertController,private app:App,public modalCtrl: ModalController,public navCtrl: NavController, public navParams: NavParams,public db:MyserviceProvider,public constant:ConstantProvider,public loadingCtrl: LoadingController)
    {
    ...
    convertLeadModal()
    {
        let convertleadmodal =  this.modal.create(ConvertLeadPage);
        
        convertleadmodal.onDidDismiss(data =>{
            this.events.publish('user:login');
            // this.last_attendence();
        });
        
        convertleadmodal.present();
    }
