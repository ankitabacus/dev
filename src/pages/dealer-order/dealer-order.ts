...
export class DealerOrderPage{
    ...
    filter:any={}
    count:any={}
    constructor(public navCtrl: NavController,public constant:ConstantProvider, private app:App,public navParams: NavParams,public db:MyserviceProvider,public storage:Storage)
    {
    ...
    ionViewWillEnter()
    {
        ...
        if((this.constant.UserLoggedInData.type==1) && !this.order_type) //that means login user is distributor
        {
