...
export class OrderListPage {
    ...
    count:any={}
    userId :any
    constructor(private app:App,public navCtrl: NavController,public constant :ConstantProvider,public loadingCtrl: LoadingController, public navParams: NavParams,public db:MyserviceProvider, public modalCtrl: ModalController, public storage: Storage, public platform: Platform, public appCtrl: App) {
    ...
    get_orders()
    {
        ...
        this.db.addData({"search":this.filter,"user_id":this.user_id,"start":this.start,"limit":this.limit,'status':this.filter.order_status,type:this.user_data.type,'userId':this.userId},"dealerData/get_ordersExecutive")
        .then(resp=>{
            console.log(resp);
    ...
    loadData(infiniteScroll)
    {
        ...
        this.db.addData({"search":this.filter,"user_id":this.user_id,"start":this.start,"limit":this.limit,'status':this.filter.order_status,'userId':this.userId},"dealerData/get_ordersExecutive")
        .then((r) =>{
            console.log(r);
            if(r['order_list']=='')
            {
